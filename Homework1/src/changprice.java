...
public class changprice {
	...
	public static void main(String[] args) {
		...
		if (result <= 0 ){ JOptionPane.showMessageDialog(null, "System Error","System Error",JOptionPane.ERROR_MESSAGE); } 
		else { float changsud = (float)(Float.parseFloat(ipusd)/32.73);
